        ...
        <form id="form_data" enctype="multipart/form-data" files="true">
            ...
            <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                    <div class="card-text">
                        <h4 class="card-title">Registro De soporte al Estudiante de documentos *.Pdf *.png *.jpg</h4>
                    </div>
                </div>
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="text-align: center">
                            <h3 style="text-align: center">Datos Del estudiante</h3>
                        </div>
                        <label class="col-sm-2 col-form-label">Estudiante</label>
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group">
                                <input type="text" name="ci" id="buscar" class="buscar form-control">
                            </div>
                        </div>

                        <div id="render_cliente" class="col-md-12">

                        </div>
                        <hr>
                        <div class="col-md-12" style="text-align: center">
                            <h3 style="text-align: center">Datos Del Documento</h3>
                        </div>
                        <div  class="col-md-12">
                            <div class="row">
                                <label class="col-sm-2 col-form-label">Dirigido</label>
                                <div class="col-sm-10">
                                    <div class="form-group bmd-form-group">
                                        <input type="text" name="dirigido" class="form-control" placeholder="dirigido al ">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer ml-auto mr-auto" id="content_data">
                    <a id="send_form_as" class="btn btn-rose" style="background-color: rgb(14, 122, 99); color:aliceblue">Guardar</a>
...
<script src="{{ asset('material') }}/inputfile/js/locales/es.js"></script>
  <script>
    ...
    $('#buscar').keyup(delay(function (e) {
        var input=$('#buscar').val();
        console.log(input);
        if (input.length <= 0) {
          $(".buscar").css("background-color", "pink");
        }else{
          $(".buscar").css("background-color", "#74A946");
          var token ='{{csrf_token()}}';
           $.ajax({
              url: URL_BASE + '/Apiselectestudent',
              type: 'GET',
              headers: {
                'X-CSRF_TOKEN': token
              },
