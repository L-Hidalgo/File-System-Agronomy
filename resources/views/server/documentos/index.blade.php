            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-icon card-header-rose">
                        <div class="card-icon">
                            <a href="{{route('addfilecom')}}" style="color: aliceblue"><i class="material-icons">archive</i></a>
                        </div>
                        <div class="card-icon">
                            <a href="{{route('addfilesdatacam')}}"  style="color: aliceblue"><i class="material-icons">camera_alt</i></a>
                        </div>
                        @if(auth()->user()->tipo=='secretario')
                        <div class="card-icon">
                            <a id="modaldat"  style="color: aliceblue"><i class="material-icons">art_track</i></a>
                        </div>
                        @endif
...
<script src="{{ asset('material') }}/inputfile/js/locales/es.js"></script>
  <script>
    ...
    $(document).on('click','#send_search', function(e){
        ...
        var url = URL_BASE + '/searchdatainput';
        e.preventDefault();
        $('span.msgerror').html('');
